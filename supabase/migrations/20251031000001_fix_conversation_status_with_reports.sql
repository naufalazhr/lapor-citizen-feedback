-- =============================================================================
-- Fix Conversation Status Based on Actual Reports in Database
-- This migration properly matches conversations with reports and updates status
-- =============================================================================
...
BEGIN
  RAISE NOTICE '=============================================================================';
  RAISE NOTICE 'Starting conversation status fix based on actual reports...';
  RAISE NOTICE '=============================================================================';

  -- Step 1: Match conversations with reports and mark as COMPLETED
  -- Logic: Find reports that match conversation phone number and were created
  -- during or shortly after the conversation timeframe
  RAISE NOTICE '';
  RAISE NOTICE 'Step 1: Matching conversations with reports...';
  ...
  LOOP
    ...
    RAISE NOTICE '  ✓ Conversation % → COMPLETED (linked to report %)',
