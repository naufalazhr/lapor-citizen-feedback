-- ============================================================================
-- Add self-protection to assign_user_role()
-- Prevents an admin from demoting or changing their own role, which would
-- lock them out of the system. Industry standard: admins cannot modify own role.
-- ============================================================================
