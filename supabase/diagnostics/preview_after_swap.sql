-- =============================================================================
-- Preview: Conversation-Report Matching AFTER Column Swap
-- Run this AFTER running migration 20251031000002 (column swap)
-- This shows which conversations will be matched with reports
-- =============================================================================
...
-- Show matching logic
SELECT '================================================' AS divider;
SELECT 'MATCHING PREVIEW (After Swap)' AS title;
SELECT '================================================' AS divider;
...
WITH matched AS (
  SELECT DISTINCT ON (c.id)
    ...
    c.phone_number AS user_phone,
    c.device_number AS bot_device,
  ...
  INNER JOIN reports r ON c.phone_number = r.phone  -- Now correct after swap!
  WHERE
