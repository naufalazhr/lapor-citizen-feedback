      ...
      <div className="space-y-6">
        <div>
          ...
          <p className="text-muted-foreground">
            Kelola API key, konfigurasi field, dan dokumentasi integrasi
          </p>
        </div>
                ...
                <Tabs defaultValue="curl" className="w-full">
                  ...
                  <TabsContent value="curl" className="space-y-4">
                    <div className="relative">
                      ...
                      >
                        {copied === "cURL code" ? <Check className="h-4 w-4" /> : <Copy className="h-4 w-4" />}
                      </Button>
                    </div>
                  </TabsContent>
                  ...
                  <TabsContent value="javascript" className="space-y-4">
                    <div className="relative">
                      ...
                      >
                        {copied === "JavaScript code" ? <Check className="h-4 w-4" /> : <Copy className="h-4 w-4" />}
                      </Button>
                    </div>
                  </TabsContent>
                  ...
                  <TabsContent value="python" className="space-y-4">
                    <div className="relative">
                      ...
                      >
                        {copied === "Python code" ? <Check className="h-4 w-4" /> : <Copy className="h-4 w-4" />}
                      </Button>
                    </div>
                  </TabsContent>
                  ...
                  <TabsContent value="php" className="space-y-4">
                    <div className="relative">
                      ...
                      >
                        {copied === "PHP code" ? <Check className="h-4 w-4" /> : <Copy className="h-4 w-4" />}
                      </Button>
                    </div>
                  </TabsContent>
                </Tabs>
